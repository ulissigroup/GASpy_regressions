...
comparison_name="HER"
python -c "from gaspy_regress.io import gdrive_dump; gdrive_dump('$gsheet', '$worksheet', predictions_path='$predictions_path', comparisons_path='$comparisons_path', identifying_labels='$identifying_labels', reporting_labels='$reporting_labels', comparison_name='$comparison_name')"

# HER
gsheet="gasdb_predictions"
worksheet="HER_T"
predictions_path="/global/project/projectdirs/m2755/GASpy/GASpy_regressions/pkls/CO2RR_predictions_GP_around_TPOT_FEATURES_coordcount_neighbors_coordcounts_RESPONSES_energy_BLOCKS_adsorbate.pkl"
python -c "from gaspy_regress.io import gdrive_dump; gdrive_dump('$gsheet', '$worksheet', predictions_path='$predictions_path')"
