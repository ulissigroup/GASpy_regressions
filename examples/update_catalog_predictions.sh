...
if ! squeue -u ktran | grep -E 'regress|predict|push'; then
    ...
    push=$(sbatch --parsable --dependency=$dependencies /global/project/projectdirs/m2755/GASpy_workspaces/GASpy/GASpy_regressions/examples/regression_scripts/push_predictions.sh)
fi
